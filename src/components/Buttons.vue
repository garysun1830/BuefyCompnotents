<template>
    <section>
        <div class="buttons">
            <b-button type="is-primary" size="is-small">Primary</b-button>
            <b-button type="is-primary is-light">Primary Light</b-button>

            <b-button type="is-success" size="is-medium">Success</b-button>
            <b-button type="is-success is-light" size="is-large">Success Light</b-button>
